...
const INTRO_SLIDES = [
	...
	["res://assets/intro_img/slide_4.png", "Mas ha uma esperanca! Leo, nosso pequeno heroi, descobriu que, ao consumir as frutas e verduras restantes, ele(a) ganha poderes especiais: a forca da cenoura, a velocidade da banana e a energia da agua. Somente com a coragem de fazer escolhas saudaveis e usar o poder da natureza voce podera enfrentar os Junkz, restaurar a Fonte da Saude e salvar a Vila Viva!"],
